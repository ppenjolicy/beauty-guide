...
public class Lip4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Lip4.this,MainActivity.class));
            }
        });
        ...
        cir6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip4.this,Lip6.class)); }
        });
        cir7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(Lip4.this,Lip7.class)); }
        });
        cir8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(Lip4.this,Lip8.class)); }
        });
        cir9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(Lip4.this,Lip9.class)); }
        });
        cir2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip4.this,Lip2.class));
            }
        });
        cir3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip4.this,Lip3.class));
            }
        });
        cir5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip4.this,Lip5.class));
            }
        });
        cir1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip4.this,Lip1.class));
            }
        });/**End Menu**/
        ...
        Texture.builder()
                .setSource(this,R.drawable.lip44)
                .build()
