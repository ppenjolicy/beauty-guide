...
public class Lip5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Lip5.this,MainActivity.class));
            }
        });
        ...
        cir6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip5.this,Lip6.class)); }
        });
        cir7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(Lip5.this,Lip7.class)); }
        });
        cir8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(Lip5.this,Lip8.class)); }
        });
        cir9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(Lip5.this,Lip9.class)); }
        });
        cir2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip5.this,Lip2.class));
            }
        });
        cir3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip5.this,Lip3.class));
            }
        });
        cir4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip5.this,Lip4.class));
            }
        });
        cir1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lip5.this,Lip1.class));
            }
        });/**End Menu**/
        ...
        Texture.builder()
                .setSource(this,R.drawable.lip55)
                .build()
