...
public class Ab1l3e2b3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Ab1l3e2b3.this,MainActivity.class));
            }
        });
        ...
        cir4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab1l3e2b3.this,Brown4.class));
            }
        });
        cir5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab1l3e2b3.this,Brown5.class));
            }
        });
        /**End Menu**/
        ...
        Texture.builder()
                .setSource(this,R.drawable.ab1l3e2b3)
                .build()
