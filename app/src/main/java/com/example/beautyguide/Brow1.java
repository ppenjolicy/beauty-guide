...
public class Brow1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Brow1.this,MainActivity.class));
            }
        });
        ...
        cir3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Brow1.this,Brown3.class));
            }
        });
        cir4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Brow1.this,Brown4.class));
            }
        });
        cir5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Brow1.this,Brown5.class));
            }
        });
        cir2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Brow1.this,Brown2.class));
            }
        });/**End Menu**/
        ...
        Texture.builder()
                .setSource(this,R.drawable.brow1)
                .build()
