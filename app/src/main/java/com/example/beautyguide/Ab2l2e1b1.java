...
public class Ab2l2e1b1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b1.this,MainActivity.class));
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b1.this,Ab2l2e1.class));
            }
        });
        ...
        cir2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b1.this,Ab2l2e1b2.class));
            }
        });
        cir3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b1.this,Ab2l2e1b3.class));
            }
        });
        /**End Menu**/
        ...
        Texture.builder()
                .setSource(this,R.drawable.b2l2e1b1)
                .build()
