...
public class Ab2l2e1b3 extends AppCompatActivity {

    private ModelRenderable modelRenderable;
    private Texture texture;
    private boolean isAdded = false;

    private CircleImageView cir1,cir2,cir3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b3.this,MainActivity.class));
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b3.this,Ab2l2e1.class));
            }
        });
        ...
        cir2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b3.this,Ab2l2e1b2.class));
            }
        });
        cir3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ab2l2e1b3.this,Ab2l2e1b3.class));
            }
        });
        /**End Menu**/
        ...
        Texture.builder()
                .setSource(this,R.drawable.b2l2e1b3)
                .build()
